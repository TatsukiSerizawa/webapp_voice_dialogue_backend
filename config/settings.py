...
ALLOWED_HOSTS = ["voice-dialogue-backend-bzazcff4dmdrdvh4.japaneast-01.azurewebsites.net", "localhost", "127.0.0.1"]
# ALLOWED_HOSTS = ["*"]

if not OEPNAI_API_KEY:
    raise ValueError("OPENAI_API_KEYが設定されていません。")
if not NIJI_VOICE_API_KEY:
    raise ValueError("NIJI_VOICEAPI_KEYが設定されていません。")
